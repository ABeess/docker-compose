...
import { getCourse, singleDeleteCourse, singleDeleteCourseMeta } from 'src/api/courseList.api';
...
export default function CourseList() {
  ...
  const handleDeleteRow = async (_id) => {
    try {
      await Promise.all([singleDeleteCourse(_id), singleDeleteCourseMeta({ courseId: _id })]);
